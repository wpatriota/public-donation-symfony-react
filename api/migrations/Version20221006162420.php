 ...
 */
final class Version20221006162420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donor DROP status');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donor ADD status TEXT NOT NULL');
